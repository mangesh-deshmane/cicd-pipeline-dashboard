# CI/CD Pipeline Dashboard - Terraform Infrastructure
# This configuration deploys the dashboard to AWS using ECS, RDS, and ALB
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        ...
        {
          name      = "WRITE_KEY"
          valueFrom = aws_ssm_parameter.write_key.arn
        }
      ]
    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          aws_ssm_parameter.write_key.arn
        ]
      }
    ]
  })
...
resource "aws_ssm_parameter" "smtp_password" {
  ...
  type  = "SecureString"
  value = var.smtp_password != "" ? var.smtp_password : "placeholder"
...
resource "aws_ssm_parameter" "write_key" {
  name  = "/${var.project_name}/write-key"
  type  = "SecureString"
  value = var.write_key != "" ? var.write_key : random_password.db_password.result
...
# ECR Repository (optional - if you want to manage it with Terraform)
